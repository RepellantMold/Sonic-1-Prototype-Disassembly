...
namespace S1ObjectDefinitions.GHZ
{
	class SwingingPlatform : ObjectDefinition
	{
		...
		{
			imgwreckingball = ObjectHelper.MapASMToBmp(ObjectHelper.OpenArtFile("../Art/Nemesis/GHZBall.bin", CompressionType.Nemesis), "../Map/Obj48.asm", 1, 2);
			for (int i = 0; i < labels.Length; i++)
				imgs.Add(ObjectHelper.MapASMToBmp(ObjectHelper.OpenArtFile("../Art/Nemesis/SwingPltfrm.bin", CompressionType.Nemesis), "../Map/SwingingPlatform.asm", labels[i], i == 1 ? 0 : 2));
		}
